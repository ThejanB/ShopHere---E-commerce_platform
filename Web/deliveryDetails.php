  ...
  <div class="container">
    ...
    <div class="row g-0 d-flex align-items-center">
        <div class="col-lg-4 d-none d-lg-flex">
          <img src="assets/shippingImage.jpg" alt="Welcome to ShopHere"
      ...
      <div class="card mb-4">
        ...
        <?php endif;?>
            ...
            <div class="form-outline mb-4">
              <input type="text" id="form11Example3" name="inputAddress" class="form-control" />
            ...
            <div class="row mb-4">
              <div class="col">
                <div class="form-outline">
                  <input type="text" id="form11Example1"  name="inputZipCode" class="form-control" />
                  <label class="form-label" for="form11Example1">Zip Code</label>
                </div>
              </div>
              <div class="col">
                <div class="form-outline">
                  <input type="text" id="form11Example2" name="inputStreet"  class="form-control" />
            ...
            <!-- Text input -->
            <div class="form-outline mb-4">
              <input type="text" id="form11Example4" name="inputCity" class="form-control" />
              <label class="form-label" for="form11Example4">City</label>
            </div>

            <!-- Text input -->
            <div class="form-outline mb-4">
              <input type="text" id="form11Example5" name="inputProvince" class="form-control" />
              <label class="form-label" for="form11Example4">Province</label>
            </div>

            
            <!-- Number input -->
            <div class="form-outline mb-4">
              <input type="number" id="form11Example6" name="inputMobile" class="form-control" />
              <label class="form-label" for="form11Example6">Phone Number</label>
            </div> 

          
            <div class="text-center">
              <button type="submit" name="buttonConfirmedDetails" class="btn button-order col-md-10" style="width:40%; height:40px; font-size: 18px;">Confirm Details</button>
            </div>
        </div>
